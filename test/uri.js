...
describe('URI', function() {
  ...
  it('parses uri strings correctly (test vector)', function() {
    ...
    uri = URI.parse('bitcoin:jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N');
    uri.address.should.equal('jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N');
    expect(uri.amount).to.be.undefined();
    expect(uri.otherParam).to.be.undefined();

    uri = URI.parse('bitcoin:jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N?amount=123.22');
    uri.address.should.equal('jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N');
  ...
  it('URIs can be validated statically (test vector)', function() {
    URI.isValid('bitcoin:jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N').should.equal(true);
    URI.isValid('bitcoin:TEznnNig4TAsv4pQmHWVMPjVthoUwbDZgm').should.equal(true);

    URI.isValid('bitcoin:jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N?amount=1.2')
                .should.equal(true);
    URI.isValid('bitcoin:jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N?amount=1.2&other=param')
                .should.equal(true);
    URI.isValid('bitcoin:jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N?amount=1.2&req-other=param',
                ['req-other']).should.equal(true);
    URI.isValid('bitcoin:TGK5wBbhouLkQzDbvWVLG8To8ZUTJbb5Ht?amount=0.1&' +
  ...
  it('do not need new keyword', function() {
    var uri = URI('bitcoin:jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N');
  ...
  describe('instantiation from bitcoin uri', function() {
    ...
    it('parses address', function() {
      uri = new URI('bitcoin:jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N');
      uri.address.should.be.instanceof(bitcore.Address);
      uri.network.should.equal(Networks.livenet);
    });

    it('parses amount', function() {
      uri = URI.fromString('bitcoin:jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N?amount=123.22');
      uri.address.toString().should.equal('jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N');
      uri.amount.should.equal(12322000000);
      expect(uri.otherParam).to.be.undefined();
    });

    it('parses a testnet address', function() {
      uri = new URI('bitcoin:TEznnNig4TAsv4pQmHWVMPjVthoUwbDZgm');
      uri.address.should.be.instanceof(bitcore.Address);
      uri.network.should.equal(Networks.testnet);
    });

    it('stores unknown parameters as "extras"', function() {
      uri = new URI('bitcoin:jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N?amount=1.2&other=param');
      uri.address.should.be.instanceof(bitcore.Address);
    ...
    it('throws error when a required feature is not supported', function() {
      (function() {
        return new URI('bitcoin:jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N?amount=1.2&other=param&req-required=param');
      }).should.throw(Error);
    });
  ...
  it('should create instance from object', function() {
    ...
    uri = new URI({
      address: 'jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N'
    });
    uri.address.should.be.instanceof(bitcore.Address);
    uri.network.should.equal(Networks.livenet);

    uri = new URI({
      address: 'TEznnNig4TAsv4pQmHWVMPjVthoUwbDZgm'
    });
    uri.address.should.be.instanceof(bitcore.Address);
    uri.network.should.equal(Networks.testnet);
  ...
  it('should support double slash scheme', function() {
    var uri = new URI('bitcoin://jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N');
    uri.address.toString().should.equal('jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N');
  });

  it('should input/output String', function() {
    var str = 'bitcoin:jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N?' +
  ...
  it('should support numeric amounts', function() {
    var uri = new URI('bitcoin:jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N?amount=12.10001');
  ...
  it('should generate a valid URI', function() {
    new URI({
      ...
      'bitcoin:jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N'
    );
    ...
    new URI({
      ...
      'bitcoin:jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N?amount=1.10001&message=Hello%20World&something=else'
    );

  });

  it('should be case insensitive to protocol', function() {
    var uri1 = new URI('bItcOin:jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N');
    var uri2 = new URI('bitcoin:jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N');

    uri1.address.toString().should.equal(uri2.address.toString());
  });

  it('writes correctly the "r" parameter on string serialization', function() {
    var originalString = 'bitcoin:TGK5wBbhouLkQzDbvWVLG8To8ZUTJbb5Ht?amount=0.1&' +
  ...
  it('displays nicely on the console (#inspect)', function() {
    var uri = 'bitcoin:jTsRY5ecUPZYa7S4Sm2hDPqWkSDdqCf97N';
