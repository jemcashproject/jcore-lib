...
describe('MultiSigScriptHashInput', function() {
  ...
  var privateKey1 = new PrivateKey(AddrUtils.bitcoin_address_to_jemcash('KwF9LjRraetZuEjR8VqEq539z137LW5anYDUnVK11vM3mNMHTWb4'));
  var privateKey2 = new PrivateKey(AddrUtils.bitcoin_address_to_jemcash('L4PqnaPTCkYhAqH3YQmefjxQP6zRcF4EJbdGqR8v6adtG9XSsadY'));
  var privateKey3 = new PrivateKey(AddrUtils.bitcoin_address_to_jemcash('L4CTX79zFeksZTyyoFuPQAySfmP7fL3R41gWKTuepuN7hxuNuJwV'));
  var public1 = privateKey1.publicKey;
  var public2 = privateKey2.publicKey;
  var public3 = privateKey3.publicKey;
  var address = new Address(AddrUtils.bitcoin_address_to_jemcash('33zbk2aSZYdNbRsMPPt6jgy6Kq1kQreqeb'));

  var output = {
    address: AddrUtils.bitcoin_address_to_jemcash('33zbk2aSZYdNbRsMPPt6jgy6Kq1kQreqeb'),
