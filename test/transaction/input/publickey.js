...
describe('PublicKeyInput', function() {
  ...
  var utxo = {
    ...
    vout: 0,
    address: AddrUtils.bitcoin_address_to_jemcash('n4McBrSkw42eYGX5YMACGpkGUJKL3jVSbo'),
    scriptPubKey: '2103c9594cb2ebfebcb0cfd29eacd40ba012606a197beef76f0269ed8c101e56ceddac',
    amount: 50,
    confirmations: 104,
    spendable: true
  };
  var privateKey = PrivateKey.fromWIF(AddrUtils.bitcoin_address_to_jemcash('cQ7tSSQDEwaxg9usnnP1Aztqvm9nCQVfNWz9kU2rdocDjknF2vd6'));
