...
describe('Transaction', function() {
  ...
  var testTransaction = new Transaction()
    ...
    .to(AddrUtils.bitcoin_address_to_jemcash('mrU9pEmAx26HcbKVrABvgL7AwA5fjNFoDc'), testAmount - 10000);
  ...
  var fromAddress = AddrUtils.bitcoin_address_to_jemcash('mszYqVnqKoQx4jcTdJXxwKAissE3Jbrrc1');
  ...
  var toAddress = AddrUtils.bitcoin_address_to_jemcash('mrU9pEmAx26HcbKVrABvgL7AwA5fjNFoDc');
  var changeAddress = AddrUtils.bitcoin_address_to_jemcash('mgBCJAsvzgT2qNNeXsoECg2uPKrUsZ76up');
  var changeAddressP2SH = AddrUtils.bitcoin_address_to_jemcash('2N7T3TAetJrSCruQ39aNrJvYLhG1LJosujf');
  var privateKey = AddrUtils.bitcoin_address_to_jemcash('cSBnVM4xvxarwGQuAfQFwqDg9k5tErHUHzgWsEfD4zdwUasvqRVY');
  ...
  var p2shPrivateKey1 = PrivateKey.fromWIF(AddrUtils.bitcoin_address_to_jemcash('cNuW8LX2oeQXfKKCGxajGvqwhCgBtacwTQqiCGHzzKfmpHGY4TE9'));
  var p2shPublicKey1 = p2shPrivateKey1.toPublicKey();
  var p2shPrivateKey2 = PrivateKey.fromWIF(AddrUtils.bitcoin_address_to_jemcash('cTtLHt4mv6zuJytSnM7Vd6NLxyNauYLMxD818sBC8PJ1UPiVTRSs'));
  var p2shPublicKey2 = p2shPrivateKey2.toPublicKey();
  var p2shPrivateKey3 = PrivateKey.fromWIF(AddrUtils.bitcoin_address_to_jemcash('cQFMZ5gP9CJtUZPc9X3yFae89qaiQLspnftyxxLGvVNvM6tS6mYY'));
  ...
  describe('Segregated Witness', function() {
    ...
    describe('signing', function() {
      var privateKey1 = PrivateKey.fromWIF(AddrUtils.bitcoin_address_to_jemcash('cNuW8LX2oeQXfKKCGxajGvqwhCgBtacwTQqiCGHzzKfmpHGY4TE9'));
      var publicKey1 = p2shPrivateKey1.toPublicKey();
      var privateKey2 = PrivateKey.fromWIF(AddrUtils.bitcoin_address_to_jemcash('cTtLHt4mv6zuJytSnM7Vd6NLxyNauYLMxD818sBC8PJ1UPiVTRSs'));
      var publicKey2 = p2shPrivateKey2.toPublicKey();
      var privateKey3 = PrivateKey.fromWIF(AddrUtils.bitcoin_address_to_jemcash('cQFMZ5gP9CJtUZPc9X3yFae89qaiQLspnftyxxLGvVNvM6tS6mYY'));
      ...
      it('will sign with nested p2sh witness program', function() {
        var tx = new Transaction()
          ...
          .to([{address: AddrUtils.bitcoin_address_to_jemcash('n3LsXgyStG2CkS2CnWZtDqxTfCnXB8PvD9'), satoshis: 50000}])
          .fee(150000)
          .change(AddrUtils.bitcoin_address_to_jemcash('mqWDcnW3jMzthB8qdB9SnFam6N96GDqM4W'))
          .sign(privateKey1);
