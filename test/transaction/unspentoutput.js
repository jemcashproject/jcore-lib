...
describe('UnspentOutput', function() {
  ...
  var sampleData1 = {
    'address': AddrUtils.bitcoin_address_to_jemcash('mszYqVnqKoQx4jcTdJXxwKAissE3Jbrrc1'),
  ...
  var sampleData2 = {
    ...
    'vout': 1,
    'address': AddrUtils.bitcoin_address_to_jemcash('mgBCJAsvzgT2qNNeXsoECg2uPKrUsZ76up'),
  ...
  it('displays nicely on the console', function() {
    var expected = '<UnspentOutput: a477af6b2667c29670467e4e0728b685ee07b240235771862318e29ddbe58458:0' +
                   ', satoshis: 1020000, address: '+ AddrUtils.bitcoin_address_to_jemcash('mszYqVnqKoQx4jcTdJXxwKAissE3Jbrrc1') + '>';
