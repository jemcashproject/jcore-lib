...
describe('PublicKey', function() {
  ...
  describe('instantiation', function() {
    ...
    it('problematic secp256k1 public keys', function() {
      ...
      var knownKeys = [
        {
          wif: AddrUtils.bitcoin_address_to_jemcash('KzsjKq2FVqVuQv2ueHVFuB65A9uEZ6S1L6F8NuokCrE3V3kE3Ack'),
        ...
        {
          wif: AddrUtils.bitcoin_address_to_jemcash('L5MgSwNB2R76xBGorofRSTuQFd1bm3hQMFVf3u2CneFom8u1Yt7G'),
  ...
  describe('hashes', function() {
    ...
    var data = [
      [AddrUtils.bitcoin_address_to_jemcash('5HxWvvfubhXpYYpS3tJkw6fq9jE9j18THftkZjHHfmFiWtmAbrj'), AddrUtils.bitcoin_address_to_jemcash('1QFqqMUD55ZV3PJEJZtaKCsQmjLT6JkjvJ')],
      [AddrUtils.bitcoin_address_to_jemcash('5KC4ejrDjv152FGwP386VD1i2NYc5KkfSMyv1nGy1VGDxGHqVY3'), AddrUtils.bitcoin_address_to_jemcash('1F5y5E5FMc5YzdJtB9hLaUe43GDxEKXENJ')],
      [AddrUtils.bitcoin_address_to_jemcash('Kwr371tjA9u2rFSMZjTNun2PXXP3WPZu2afRHTcta6KxEUdm1vEw'), AddrUtils.bitcoin_address_to_jemcash('1NoJrossxPBKfCHuJXT4HadJrXRE9Fxiqs')],
      [AddrUtils.bitcoin_address_to_jemcash('L3Hq7a8FEQwJkW1M2GNKDW28546Vp5miewcCzSqUD9kCAXrJdS3g'), AddrUtils.bitcoin_address_to_jemcash('1CRj2HyM1CXWzHAXLQtiGLyggNT9WQqsDs')]
    ];
