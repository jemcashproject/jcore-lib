...
<head>
  <meta charset="utf-8">
  <script src="bower_components/bitcore/jcore-lib.min.js"></script>
...
```sh
browserify --require ./index.js:jcore-lib | uglifyjs > jcore-lib.min.js
```

```sh
browserify --require ./index.js:bitcore-mnemonic --external jcore-lib | uglifyjs > bitcore-mnemonic.min.js
```
